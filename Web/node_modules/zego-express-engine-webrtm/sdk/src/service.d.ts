...
export declare class LiveRoomService {
    ...
    heartBeat(suc: Function, err: Function, sessionID: string, roomID: string, roomSessionID: string): number;
    fetchUserList(body: any, suc: Function, err: Function, sessionID: string, roomID: string, roomSessionID: string): number;
    fetchUserListV2(body: any, suc: Function, err: Function, sessionID: string, roomID: string, roomSessionID: string): number;
    fetchReliableMessage(body: any, suc: Function, err: Function, sessionID: string, roomID: string, roomSessionID: string): number;
    sendReliableMessage(body: any, suc: Function, err: Function, sessionID: string, roomID: string, roomSessionID: string): number;
    sendRoomMsg(body: any, suc: Function, err: Function, sessionID: string, roomID: string, roomSessionID: string): number;
    sendCustomCommand(body: any, suc: Function, err: Function, sessionID: string, roomID: string, roomSessionID: string): number;
    sendBigRoomMessage(body: any, suc: Function, err: Function, sessionID: string, roomID: string, roomSessionID: string): number;
    sendRelayMessage(body: any, suc: Function, err: Function, sessionID: string, roomID: string, roomSessionID: string): number;
    sendSignalCmd(body: any, suc: Function, err: Function, sessionID: string, roomID: string, roomSessionID: string): number;
